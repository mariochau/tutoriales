...
<div id="banner" class="coordinadores">
</div>
<div id="linea2">
</div>
...
<div id="main">
	<div id="container1" class="clearfix">
		<table width="1024px" height="300px" cellspacing="10px">
		<tr>
		...
		<tr>
			...
			<td>
				...
				<tr>
					<td class="flecha" width="5%" height="25%"></td>
					<td>
						<a class="titulo" href = "javascript:void(0)"  onclick="doshow(4)">&iquest;C&oacute;mo imprimir una prueba v&iacute;a Webcursos-UAI?</a>
    					...
    					<div id="light4" class="white_content">    					    
    						<div class="fondo">
    							<a class="cerrar" href = "javascript:void(0)" onclick = "dohide(4)">Cerrar</a>
    					  		...
    					  		<iframe width="100%" height="90%" src="//www.youtube.com/embed/bZtPZbxqmes" frameborder="0"></iframe>
    					</div>
		...
		<tr>
			<td width="50%" height="34%">
				...
				<tr>
					<td class="flecha" width="5%" height="25%"></td>
					<td>
						<a class="titulo" href = "javascript:void(0)"  onclick="doshow(5)">&iquest;C&oacute;mo convertir un documento Word en PDF?</a>
						<div class="nivel">Nivel Medio</div>
